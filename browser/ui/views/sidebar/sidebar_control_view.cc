...
gfx::Size SidebarControlView::CalculatePreferredSize() const {
  gfx::Size preferred_size = sidebar_items_view_->GetPreferredSize();
  preferred_size.Enlarge(0,
                         sidebar_item_add_view_->GetPreferredSize().height());
  preferred_size.Enlarge(0,
                         sidebar_settings_view_->GetPreferredSize().height());
  preferred_size += GetInsets().size();
